...
public class LoginButtonFragment extends BaseFragment {
    public static final String EXTRA_LOGIN_BUTTON_TITLE = "com.trimble.trimfleet.login_button_title";
    public static final String EXTRA_LOGIN_BUTTON_DRAWABLE = "com.trimble.trimfleet.login_button_drawable";
    private View view;
    ...
    public static LoginButtonFragment newInstance(Integer title, Integer drawable) {
        Bundle args = new Bundle();
        args.putInt(EXTRA_LOGIN_BUTTON_TITLE, title);
        args.putInt(EXTRA_LOGIN_BUTTON_DRAWABLE, drawable);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (args != null) {
            setTitleResource(args.getInt(EXTRA_LOGIN_BUTTON_TITLE));
            setDrawableResource(args.getInt(EXTRA_LOGIN_BUTTON_DRAWABLE));
        }
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        view = inflater.inflate(R.layout.frag_login_button, null);
